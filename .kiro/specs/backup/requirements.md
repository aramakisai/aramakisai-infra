...
- Backblaze B2 への障害・プロバイダー障害に備え、Google Drive を二次バックアップ先とする
- Rclone CronJob が毎日 04:00 UTC に `aramakisai-backups` バケット全体を Google Drive の専用フォルダへ同期する (CNPG 02:00 + VolSync 最終回 完了後)
...
- Google Drive からの直接リストア: Backblaze B2 からのリストアを正とし、Google Drive はコールドバックアップとして扱う
